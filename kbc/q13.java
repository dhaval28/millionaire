...
public class q13 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		...
		setSize(1100,760); 
		b1= new Button("Jews");
		b2= new Button("Parsees");
		b3= new Button("Muslims");
		b4= new Button("Christians");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b2)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 25,00,000 Rs.\n\nProceed to next Question?");	
		
		q14 e11= new q14(ffused);
		setVisible(false);
	}
	...
	b2.setBackground(Color.green);
	JOptionPane.showMessageDialog(null,"Incorrect Answer..\n\nThe correct answer is (b)Parsees.");
