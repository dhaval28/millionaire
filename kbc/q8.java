...
public class q8 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		this.c=ffused;
		ImageIcon i = new ImageIcon("8.jpg");
		...
		setVisible(true);
		setSize(1100,760); 
		b1= new Button("Mahatma Gandhi");
		b2= new Button("Sanjay Gandhi");
		b3= new Button("Pratap Singh Kairon");
		b4= new Button("Indira Gandhi");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b2)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 80,000 Rs.\n\nProceed to next Question?");	
		
		q9 e11= new q9(ffused);
		setVisible(false);
	}
	if(ae.getSource()==b1 || ae.getSource()==b3 || ae.getSource()==b4)
	{
	b1.setBackground(Color.red);
	b4.setBackground(Color.red);
	b3.setBackground(Color.red);
	b2.setBackground(Color.green);
	JOptionPane.showMessageDialog(null,"Incorrect Answer..\n\nThe correct answer is (b)Sanjay Gandhi.");
