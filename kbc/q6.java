...
public class q6 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		this.c=ffused;
		ImageIcon i = new ImageIcon("6.jpg");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b1)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 20,000 Rs.\n\nProceed to next Question?");	
		
		q7 e11= new q7(ffused);
		setVisible(false);
	}
