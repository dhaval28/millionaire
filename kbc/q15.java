...
public class q15 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		this.c=ffused;
		ImageIcon i = new ImageIcon("15.jpg");
		...
		setVisible(true);
		setSize(1100,760); 
		b1= new Button("Tiger Skin");
		b2= new Button("Fair");
		b3= new Button("Golden");
		b4= new Button("Dark Brown");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	b4.setBackground(Color.green);
	JOptionPane.showMessageDialog(null,"Incorrect Answer..\n\nThe correct answer is (d)Dark Brown.");
