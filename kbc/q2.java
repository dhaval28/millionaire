...
public class q2 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b4)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 2000 Rs.\n\nProceed to next Question?");	
		q3 e11 = new q3(ffused);
		setVisible(false);
		
	}
	if(ae.getSource()==b2 || ae.getSource()==b3 || ae.getSource()==b1)
	{
	b1.setBackground(Color.red);
	b2.setBackground(Color.red);
	b4.setBackground(Color.red);
	b3.setBackground(Color.green);
	JOptionPane.showMessageDialog(null,"Incorrect Answer..\n\nThe correct answer is (d)1945.");
