...
public class q5 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		this.c=ffused;
		ImageIcon i = new ImageIcon("5.jpg");
		...
		b1= new Button("Euro");
		b2= new Button("Yen");
		b3= new Button("Dollar");
		b4= new Button("European Dollar");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b1)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 10,000 Rs.\n\nProceed to next Question?");	
		
		q6 e11= new q6(ffused);
		setVisible(false);
	}
