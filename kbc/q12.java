...
public class q12 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		this.c=ffused;
		ImageIcon i = new ImageIcon("12.jpg");
		...
		setVisible(true);
		setSize(1100,760); 
		b1= new Button("Kapil Dev");
		b2= new Button("Rabindranath Tagore");
		b3= new Button("C.V. Raman");
		b4= new Button("S. Radhakrishnan");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b4)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 12,50,000 Rs.\n\nProceed to next Question?");	
		
		q13 e11= new q13(ffused);
		setVisible(false);
	}
	if(ae.getSource()==b1 || ae.getSource()==b3 || ae.getSource()==b2)
	{
	b1.setBackground(Color.red);
	b2.setBackground(Color.red);
	b3.setBackground(Color.red);
	b4.setBackground(Color.green);
	JOptionPane.showMessageDialog(null,"Incorrect Answer..\n\nThe correct answer is (d)S. Radhakrishnan.");
	JOptionPane.showMessageDialog(null,"Total Money won : 3,20,000 Rs");
	First x1= new First();
	repaint();
	}
}
