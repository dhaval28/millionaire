...
public class q14 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		this.c=ffused;
		ImageIcon i = new ImageIcon("14.jpg");
		...
		setVisible(true);
		setSize(1100,760); 
		b1= new Button("People Of India");
		b2= new Button("Prime Minister");
		b3= new Button("President");
		b4= new Button("Viceroy");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b1)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 50,00,000 Rs.\n\nProceed to next Question?");	
		
		q15 e11= new q15(ffused);
		setVisible(false);
	}
	...
	b1.setBackground(Color.green);
	JOptionPane.showMessageDialog(null,"Incorrect Answer..\n\nThe correct answer is (a)People Of India.");
