...
public class q11 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		...
		setVisible(true);
		setSize(1100,760); 
		b1= new Button("Holy Place");
		b2= new Button("Chair");
		b3= new Button("Wall");
		b4= new Button("King's Horse");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b3)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 6,25,000 Rs.\n\nProceed to next Question?");	
		
		q12 e11= new q12(ffused);
		setVisible(false);
	}
	if(ae.getSource()==b1 || ae.getSource()==b4 || ae.getSource()==b2)
	{
	b1.setBackground(Color.red);
	b2.setBackground(Color.red);
	b4.setBackground(Color.red);
	b3.setBackground(Color.green);
	JOptionPane.showMessageDialog(null,"Incorrect Answer..\n\nThe correct answer is (c)Wall.");
