...
public class q9 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		...
		setVisible(true);
		setSize(1100,760); 
		b1= new Button("Milkha Singh");
		b2= new Button("Swami Vivekanand");
		b3= new Button("Buddha");
		b4= new Button("Chanakya");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b3)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 1,60,000 Rs.\n\nProceed to next Question?");	
		
		q10 e11= new q10(ffused);
		setVisible(false);
	}
	if(ae.getSource()==b1 || ae.getSource()==b2 || ae.getSource()==b4)
	{
	b1.setBackground(Color.red);
	b4.setBackground(Color.red);
	b2.setBackground(Color.red);
	b3.setBackground(Color.green);
	JOptionPane.showMessageDialog(null,"Incorrect Answer..\n\nThe correct answer is (c)Buddha.");
