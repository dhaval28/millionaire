...
public class q4 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		...
		setVisible(true);
		setSize(1100,760); 
		b1= new Button("Bamboo");
		b2= new Button("Weed");
		b3= new Button("Cactus");
		b4= new Button("Palanthra");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b1)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 5000 Rs.\n\nProceed to next Question?");	
		q5 e11= new q5(ffused);
		setVisible(false);
	}
