...
public class q7 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		this.c=ffused;
		ImageIcon i = new ImageIcon("7.jpg");
		...
		setVisible(true);
		setSize(1100,760); 
		b1= new Button("Bangladesh");
		b2= new Button("Ayodhya");
		b3= new Button("Bihar");
		b4= new Button("Nepal");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b4)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 40,000 Rs.\n\nProceed to next Question?");	
		
		q8 e11= new q8(ffused);
		setVisible(false);
	}
