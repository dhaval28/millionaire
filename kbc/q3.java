...
public class q3 extends Frame implements ActionListener,MouseMotionListener
{
	int xpos;
     	int ypos;
	...
	{ 
		...
		setVisible(true);
		setSize(1100,760); 
		b1= new Button("3 Stars");
		b2= new Button("Red Cross");
		b3= new Button("Swastika");
		b4= new Button("Pigeon");
	...
	public void actionPerformed(ActionEvent ae)
{
	...
	if(ae.getSource()==b3)
	{
		...
		JOptionPane.showMessageDialog(null,"Congratulation..You won 3000 Rs.\n\nProceed to next Question?");	
		q4 e11 = new q4(ffused);
		setVisible(false);
		
	}
	if(ae.getSource()==b2 || ae.getSource()==b4 || ae.getSource()==b1)
	{
	b1.setBackground(Color.red);
	b2.setBackground(Color.red);
	b4.setBackground(Color.red);
	b3.setBackground(Color.green);
	JOptionPane.showMessageDialog(null,"Incorrect Answer..\n\nThe correct answer is (c)Swastika.");
